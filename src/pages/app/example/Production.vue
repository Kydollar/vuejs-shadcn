...
onMounted(async () => {
  ...
  if (productionEntries.value.length === 0) {
    await productionStore.fetchProductionEntries()
  }
})
</script>
  ...
  <div class="space-y-6">
    ...
    <div class="grid gap-4 md:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div class="text-2xl font-bold">
            {{ Object.keys(entriesByLine).length }}
          </div>
          <p class="text-xs text-muted-foreground">
    ...
    <Card>
      ...
      <CardContent>
        <div class="overflow-x-auto">
          <table class="w-full">
            <thead>
              <tr class="border-b">
                ...
                <th class="text-left p-4">
                  {{ $t('erp.production.line') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('erp.production.shift') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('erp.production.operator') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('erp.production.hour') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('erp.production.targetPerHour') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('erp.production.actualProduction') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('erp.production.efficiency') }}
                </th>
                <th class="text-left p-4">
                  {{ $t('common.actions') }}
                </th>
          ...
          <div v-if="productionEntries.length === 0" class="text-center py-8">
            <p class="text-muted-foreground">
              {{ $t('common.noData') }}
            </p>
          </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="space-y-2">
              ...
              <Select v-model="entryForm.line">
                ...
                <SelectContent>
                  <SelectItem value="Line A">
                    Line A
                  </SelectItem>
                  <SelectItem value="Line B">
                    Line B
                  </SelectItem>
                  <SelectItem value="Line C">
                    Line C
                  </SelectItem>
                  <SelectItem value="Line D">
                    Line D
                  </SelectItem>
                </SelectContent>
              </Select>
              ...
              <Select v-model="entryForm.shift">
                ...
                <SelectContent>
                  <SelectItem value="morning">
                    {{ $t('erp.production.morning') }}
                  </SelectItem>
                  <SelectItem value="afternoon">
                    {{ $t('erp.production.afternoon') }}
                  </SelectItem>
                  <SelectItem value="night">
                    {{ $t('erp.production.night') }}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
