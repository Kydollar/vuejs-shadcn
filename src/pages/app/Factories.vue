    ...
    <Card>
      <CardContent class="pt-6">
        <div class="text-center py-12">
          <Factory class="mx-auto h-12 w-12 text-muted-foreground mb-4" />
          <h3 class="text-lg font-semibold mb-2">{{ $t('erp.factories.title') }}</h3>
          <p class="text-muted-foreground mb-4">This feature is coming soon!</p>
          <p class="text-sm text-muted-foreground">
            Manage factory information, capacity, and specializations.
          </p>
        </div>
      </CardContent>
    </Card>
